...
int main(int argc, char *argv[])
{
    ...
    struct sockaddr_in my_addr;    //本机
    struct sockaddr_in their_addr; //客户机
    ...
    while (1)
    {
        ...
        for (int i = 0; i < conn_amount; ++i)
        {
            ...
            {
                printf("start recv from cllient[%d]:\n", i);
        ...
        if(FD_ISSET(serverfd,&client_fdset))
        {
            ...
            if(conn_amount<5)
            {
                ...
                bzero(buffer,1024);
                strcpy(buffer,"this server! welcome!\n");
